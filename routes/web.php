...
Route::middleware('auth')->group(function () {
    Route::middleware([\App\Http\Middleware\IsUser::class])->group(function () {
        Route::get('/friends', [ConnectionController::class, 'index'])->name('connection.index');
        ...
        Route::get('/connections/{connection}/accept', [ConnectionController::class, 'edit'])->name('connection.edit');
        Route::get('/connections/{connection}/reject', [ConnectionController::class, 'reject'])->name('connection.reject');
        ...
        Route::put('/connections/{connection}/reject', [ConnectionController::class, 'updateReject'])->name('connection.updateReject');
    });

    Route::middleware([\App\Http\Middleware\IsAdmin::class])->group(function () {
        Route::get('/dashboard', [UserController::class, 'index'])->name('dashboard');
        Route::get('register-user', [UserController::class, 'create'])->name('user.register');
